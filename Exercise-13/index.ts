...
let favoriteModeofTransport: Array<[transport: string, brand: string, color: string, ]> = []
...
favoriteModeofTransport.forEach(([transport, brand, color]) => 
{console.log(`"I would like to own a ${color} ${brand} ${transport}."`)})
